...
Entrada mediante texto pegado (tabla).
"""
...
def cargar_desde_pegar_tabla(datos_fuente: Dict[str, Any]) -> Tuple[dict, pd.DataFrame, pd.DataFrame, pd.DataFrame]:
    """
    Espera en datos_fuente (ejemplo):
        - "texto_estructuras": str
        - "texto_cables": str (opcional)
    ...
    # Pendiente: parsear texto a DataFrame (lo haremos cuando conectemos tu UI real)
