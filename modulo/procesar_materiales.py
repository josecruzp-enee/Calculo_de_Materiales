...
def procesar_materiales(
    ...
    # Renombra la columna "Código de Estructura" a "codigodeestructura"
    ...
    # ============================
    # 6. Calcular materiales por estructura
    # ============================
    df_total = pd.concat(
        [
