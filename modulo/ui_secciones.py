...
# modulo/ui_secciones.py (imports con esquema actual/legado)
import os
import re
import time
import pandas as pd
...
# === Esquema LEGADO (lo que tienes hoy; NO usa modulo/io) ===
...
def ruta_datos_materiales_por_defecto() -> str:
    ...
    """
    # Este archivo vive en .../modulo/ui_secciones.py  → subimos a raíz del repo
